...
pub(crate) struct InnerWebView {
  ...
  _document_title_changed_observer: Option<Retained<DocumentTitleChangedObserver>>,
  // We need this the keep the reference count
  _navigation_policy_delegate: Retained<WryNavigationDelegate>,
  // We need this the keep the reference count
  _download_delegate: Option<Retained<WryDownloadDelegate>>,
  // We need this the keep the reference count
  _ui_delegate: Retained<WryWebViewUIDelegate>,
  #[cfg(target_os = "macos")]
  ...
  fn new_ns_view(
    ...
    unsafe {
      ...
      let mut w = Self {
        ...
        _document_title_changed_observer: document_title_changed_observer,
        _navigation_policy_delegate: navigation_policy_delegate,
        _download_delegate: download_delegate,
